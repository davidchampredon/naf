...
prm[["age_hh_22"]] <- c(11,22,33,44)
prm[["age_hh_22_proba"]] <- c(0.8,0.1, 0.05, 0.05)
...
ws <- ddply(world, c('id_au'), summarize, n = length(id_indiv) )
ws
