...
M[['interv_start']]        <- c(-6,0)  #c(-56,-28,0,28)
M[['interv_cvg_rate']]     <- c(0.0010, 0.0120) # c(0.0010, 0.0030, 0.0060,0.0120)  #c(0.0010, 0.0030, 0.0100)
M[['interv_target']]       <- 'susceptible' #c('susceptible','young_old')
