...
public:
	...
	void add_prm_double(string name, double value)	{_prm_double_name.push_back(name); _prm_double_val.push_back(value);}
	void add_prm_uint(string name, double value)	{_prm_uint_name.push_back(name); _prm_uint_val.push_back(value);}
	void add_prm_int(string name, double value)		{_prm_int_name.push_back(name); _prm_int_val.push_back(value);}
	
	void add_prmvec_double(string name, vector<double> value)		{_prmvec_double_name.push_back(name); _prmvec_double_val.push_back(value);}
	void add_prmvec_uint(string name, vector<unsigned int> value)	{_prmvec_uint_name.push_back(name); _prmvec_uint_val.push_back(value);}
	void add_prmvec_int(string name, vector< int> value)	{_prmvec_int_name.push_back(name); _prmvec_int_val.push_back(value);}
