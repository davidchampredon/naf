...
Once the number of contacts from an infectious individual is determined, susceptible individuals in this social place are selected randomly as its contacts. In particular, age assortativity is not explicitly implemented.
